...
!function (e, t, n) {
    ...
    function a() {
        var e, t, n, a, o, i, s;
        for (var c in w)if (w.hasOwnProperty(c)) {
            if (e = [], t = w[c], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))for (n = 0; n < t.options.aliases.length; n++)e.push(t.options.aliases[n].toLowerCase());
    ...
    function d(e, n, r, a) {
        var o, s, c, d, u = "modernizr", f = i("div"), p = l();
        if (parseInt(r, 10))for (; r--;)c = i("div"), c.id = a ? a[r] : u + (r + 1), f.appendChild(c);
        return o = i("style"), o.type = "text/css", o.id = "s" + u, (p.fake ? p : f).appendChild(o), p.appendChild(f), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(t.createTextNode(e)), f.id = u, p.fake && (p.style.background = "", p.style.overflow = "hidden", d = _.style.overflow, _.style.overflow = "hidden", _.appendChild(p)), s = n(f, e), p.fake ? (p.parentNode.removeChild(p), _.style.overflow = d, _.offsetHeight) : f.parentNode.removeChild(f), !!s
    }

    function u(e, t) {
        if ("object" == typeof e)for (var n in e)q(e, n) && u(n, e[n]); else {
            e = e.toLowerCase();
    ...
    function v(e, t, a, o) {
        ...
        for (var u, f, p, m, h,
                 v = ["modernizr", "tspan", "samp"]; !U.style && v.length;)u = !0, U.modElem = i(v.shift()), U.style = U.modElem.style;
        for (p = e.length, f = 0; p > f; f++)if (m = e[f], h = U.style[m], s(m, "-") && (m = c(m)), U.style[m] !== n) {
            if (o || r(a, "undefined"))return l(), "pfx" == t ? m : !0;
            try {
                U.style[m] = a
            } catch (y) {
            }
            if (U.style[m] != h)return l(), "pfx" == t ? m : !0
        }
        return l(), !1
    }

    function y(e, t, n, a, o) {
        var i = e.charAt(0).toUpperCase() + e.slice(1), s = (e + " " + F.join(i + " ") + i).split(" ");
        return r(t, "string") || r(t, "undefined") ? v(s, t, a, o) : (s = (e + " " + $.join(i + " ") + i).split(" "), p(s, t, n))
    }
    ...
    S._prefixes = k;
    var _ = t.documentElement, P = "svg" === _.nodeName.toLowerCase();
    P || !function (e, t) {
        function n(e, t) {
        ...
        function i(e, n, r) {
            ...
            r || (r = o(n));
            var a;
            return a = r.cache[e] ? r.cache[e].cloneNode() : x.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !a.canHaveChildren || b.test(e) || a.tagUrn ? a : r.frag.appendChild(a)
        }
        ...
        function d(e) {
            for (var t, n = e.getElementsByTagName("*"), a = n.length, o = RegExp("^(?:" + r().join("|") + ")$", "i"),
                     i = []; a--;)t = n[a], o.test(t.nodeName) && i.push(t.applyElement(u(t)));
            return i
        }

        function u(e) {
            for (var t, n = e.attributes, r = n.length,
                     a = e.ownerDocument.createElement(k + ":" + e.nodeName); r--;)t = n[r], t.specified && a.setAttribute(t.nodeName, t.nodeValue);
            return a.style.cssText = e.style.cssText, a
        }

        function f(e) {
            for (var t, n = e.split("{"), a = n.length,
                     o = RegExp("(^|[\\s,>+~])(" + r().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"),
                     i = "$1" + k + "\\:$2"; a--;)t = n[a] = n[a].split("}"), t[t.length - 1] = t[t.length - 1].replace(o, i), n[a] = t.join("}");
            return n.join("{")
        }
        ...
        function m(e) {
            ...
            return !_ || e.printShived ? e : ("undefined" == typeof s[k] && s.add(k), c.attachEvent("onbeforeprint", function () {
                t();
                for (var o, i, s, c = e.styleSheets, l = [], u = c.length, p = Array(u); u--;)p[u] = c[u];
                for (; s = p.pop();)if (!s.disabled && E.test(s.media)) {
                    try {
        ...
        e.html5 = C, l(t);
        var E = /^$|\b(?:all|print)\b/, k = "html5shiv", _ = !g && function () {
    ...
    var N = "Moz O ms Webkit", $ = S._config.usePrefixes ? N.toLowerCase().split(" ") : [];
    S._domPrefixes = $;
    var z = function () {
        function e(e, t) {
            var a;
    ...
    S.hasEvent = z, Modernizr.addTest("hashchange", function () {
        ...
        var t = i("canvas"), n = "probablySupportsContext" in t ? "probablySupportsContext" : "supportsContext";
        return n in t ? t[n]("webgl") || t[n]("experimental-webgl") : "WebGLRenderingContext" in e
    }), Modernizr.addTest("cssgradients", function () {
        for (var e, t = "background-image:", n = "gradient(linear,left top,right bottom,from(#9f9),to(white));", r = "",
                 a = 0,
                 o = k.length - 1; o > a; a++)e = 0 === a ? "to " : "", r += t + k[a] + "linear-gradient(" + e + "left top, #9f9, white);";
    ...
    var A = i("input"), R = "autocomplete autofocus list placeholder max min multiple pattern required step".split(" "),
        j = {};
    Modernizr.input = function (t) {
        for (var n = 0, r = t.length; r > n; n++)j[t[n]] = !!(t[n] in A);
        return j.list && (j.list = !(!i("datalist") || !e.HTMLDataListElement)), j
    }(R);
    var O = "search tel url email datetime date month week time datetime-local number range color".split(" "), B = {};
    Modernizr.inputtypes = function (e) {
        for (var r, a, o, i = e.length, s = "1)",
                 c = 0; i > c; c++)A.setAttribute("type", r = e[c]), o = "text" !== A.type && "style" in A, o && (A.value = s, A.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(r) && A.style.WebkitAppearance !== n ? (_.appendChild(A), a = t.defaultView, o = a.getComputedStyle && "textfield" !== a.getComputedStyle(A, null).WebkitAppearance && 0 !== A.offsetHeight, _.removeChild(A)) : /^(search|tel)$/.test(r) || (o = /^(url|email)$/.test(r) ? A.checkValidity && A.checkValidity() === !1 : A.value != s)), B[e[c]] = !!o;
        return B
    ...
    Modernizr.addTest("svgclippaths", function () {
        return !!t.createElementNS && /SVGClipPath/.test(D.call(t.createElementNS("http://www.w3.org/2000/svg", "clipPath")))
    }), Modernizr.addTest("smil", function () {
        return !!t.createElementNS && /SVGAnimate/.test(D.call(t.createElementNS("http://www.w3.org/2000/svg", "animate")))
    });
    var F = S._config.usePrefixes ? N.split(" ") : [];
    S._cssomPrefixes = F;
    var I = S.testStyles = d, W = function () {
    ...
    W ? Modernizr.addTest("fontface", !1) : I('@font-face {font-family:"font";src:url("https://")}', function (e, n) {
    ...
    Modernizr.addTest("textshadow", G("textShadow", "1px 1px")), S.testAllProps = y, S.testAllProps = b, Modernizr.addTest("cssanimations", b("animationName", "a", !0)), Modernizr.addTest("backgroundsize", b("backgroundSize", "100%", !0)), Modernizr.addTest("borderimage", b("borderImage", "url() 1", !0)), Modernizr.addTest("borderradius", b("borderRadius", "0px", !0)), Modernizr.addTest("boxshadow", b("boxShadow", "1px 1px", !0)), function () {
        ...
        for (var e, t,
                 ...
                 r = 0; r < n.length; r++)e = n[r].toLowerCase(), t = b("column" + n[r]), ("breakbefore" === e || "breakafter" === e || "breakinside" == e) && (t = t || b(n[r])), Modernizr.addTest("csscolumns." + e, t)
    }(), Modernizr.addTest("flexbox", b("flexBasis", "1px", !0)), Modernizr.addTest("flexboxlegacy", b("boxDirection", "reverse", !0)), Modernizr.addTest("cssreflections", b("boxReflect", "above", !0)), Modernizr.addTest("csstransforms", function () {
    ...
    Modernizr.addAsyncTest(function () {
        ...
        if (t) {
            var r = "modernizr-" + Math.random(), a = t.open(r);
            a.onerror = function () {
                a.error && "InvalidStateError" === a.error.name ? u("indexeddb", !1) : (u("indexeddb", !0), x(t, r))
            }, a.onsuccess = function () {
                u("indexeddb", !0), x(t, r)
            }
        } else u("indexeddb", !1)
    }), Modernizr.addTest("json", "JSON" in e && "parse" in JSON && "stringify" in JSON), a(), o(T), delete S.addTest, delete S.addAsyncTest;
